...
def create_tables(connection: psycopg2.extensions.connection):
    ...
    queries = [
        ...
        FLOAT, location VARCHAR(255), description VARCHAR(255), is_active BOOLEAN NOT NULL);""",
        ...
        location_latitude FLOAT, location VARCHAR(255), image_url VARCHAR(255), description VARCHAR(255));""",
