...
def insert_new_sighting_to_database(connection: psycopg2.extensions.connection, author_id: str, missing_report_id, animal, breed, date_time, location_longitude, location_latitude, image_url, description, user_id, access_token):
    """
...
def insert_missing_report_to_database(connection: psycopg2.extensions.connection, author_id: str, pet_id, last_seen, location_longitude, location_latitude, description, access_token):
    """
